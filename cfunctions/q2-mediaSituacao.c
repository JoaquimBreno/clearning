...
****/
int Situacao(float media){ /* Situacao recebe o inteiro que for retornado abaixo */
    if( media >= 7){ /* <!-- Comentário de Joaquim: Se a media for maior igual que 7 ---> */
        return 1;   /* <!-- Comentário de Joaquim: retorna o inteiro 1 ---> */
    }
    else if( media >= 5){ /* <!-- Comentário de Joaquim: Se a media for maior igual que 5 ---> */
        return 2;   /* <!-- Comentário de Joaquim: retorna o inteiro 2 ---> */
    }
    else{ /* <!-- Comentário de Joaquim: Se a media for menor que 5 ---> */
        return 3;   /* <!-- Comentário de Joaquim: retorna o inteiro 3 ---> */
    }
}
