...
****/
float Media(float valor1, float valor2){/* <!-- Comentário de Joaquim: o tipo da função era, anteriormente, int. Modifiquei para float ---> */
    float soma = valor1 + valor2 ;      /* <!-- Comentário de Joaquim: para obter um valor real categorizei as variáveis como float ---> */
    return soma / 2; 
}
